  ...
  return (
    <header className="flex min-h-14 items-center justify-between gap-3 border-b border-border bg-surface px-4 md:hidden">
      <div className="flex min-w-0 items-center gap-2.5">
        <span aria-hidden="true" className="brand-mark flex size-8 shrink-0 items-center justify-center rounded-control bg-text-primary text-label font-bold text-text-inverse"><span className="size-2 rotate-45 rounded-[2px] border-2 border-current" /></span>
